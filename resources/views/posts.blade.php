...
@if($posts->count())
<div class="card mb-3">
    {{-- curl https://api.unsplash.com/users/samuelzeller/photos --}}
    {{-- <img src="https://api.unsplash.com/users/samuelzeller/photos?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}"> --}}
